...
class ModelProcessor(object):
    ...
    Attributes:
        ...
        tx_mm(TextXMetaModel): TextX metamodel.
    ...
    def __init__(self):
        """
        First initialize followed:
        - textX metamodel
        - coloring metamodel
        - completions metamodel
        - configuration metamodel
        """
        #self.tx_mm = metamodel_from_file("path to grammar in this project", debug=False)
        #self.tx_completions_mm = 
        self.tx_coloring_mm = metamodel_from_file(join(this_folder,'../metamodel/coloring.tx'))
        self.tx_config_mm = metamodel_from_file(join(this_folder,'../metamodel/configuration.tx'))
        ...
        try:
            ...
            self._metamodel_mtime = os.path.getmtime(gram)
    ...
    def _setup(self):
        """
        Load configuration from .config file from a workspace
        """
